...
function exportarPDF() {
  ...
  filas.forEach(fila => {
    ...
    // DATOS FILA
    // =========================
    const numero = celdas[1].textContent;
    const tropa = celdas[2].textContent;
    const equipo = celdas[3].textContent;
    const opciones = celdas[4].textContent;
    const coste = celdas[8].textContent;

    const p = celdas[5].textContent ? "x" : "";
    const m = celdas[6].textContent ? "x" : "";
    const c = celdas[7].textContent ? "x" : "";
